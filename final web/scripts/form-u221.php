...
$form = array(
	...
	'fields' => array(
		'custom_U232' => array(
			...
			'required' => true,
			'errors' => array(
				'required' => 'Field \'Product\' is required.'
			)
		),
		'Email' => array(
			'order' => 4,
			...
			'errors' => array(
				...
				'format' => 'Field \'Amount\' has an invalid email.'
			)
		),
		'custom_U228' => array(
			'order' => 6,
		...
		'custom_U447' => array(
			'order' => 10,
			'type' => 'checkbox',
			'label' => 'Send me email promotions and offers',
			'required' => true,
			'errors' => array(
				'required' => 'Field \'Send me email promotions and offers\' is required.'
			)
		)
	)
);
